...
module.exports = "<div class=\"kt-portlet\"\r\n    [ngClass]=\"{ 'kt-portlet--body-progress' : viewLoading, 'kt-portlet--body-progress-overlay' : loadingAfterSubmit }\">\r\n    <div class=\"kt-portlet__head kt-portlet__head__custom\">\r\n        <div class=\"kt-portlet__head-label\">\r\n            <h3 class=\"kt-portlet__head-title\">{{ getTitle() }}</h3>\r\n        </div>\r\n    </div>\r\n    <div>\r\n        <div class=\"kt-form\">\r\n            <div class=\"kt-portlet__body\">\r\n\r\n                <div class=\"kt-portlet__body-progress\">\r\n                    <mat-spinner [diameter]=\"20\"></mat-spinner>\r\n                </div>\r\n               <div id=\"alert\" #alert>\r\n                <kt-alert *ngIf=\"hasFormErrors\" type=\"warn\" [duration]=\"30000\" [showCloseButton]=\"true\"\r\n                    (close)=\"onAlertClose($event)\">\r\n                    {{errormessage}}\r\n                </kt-alert>\r\n            </div>\r\n\r\n                <div *ngIf=\"allbranch.length >0\" class=\"form-group kt-form__group row d-block\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n\r\n                        <mat-form-field>\r\n                            <mat-label> All Branchs :</mat-label>\r\n                            <mat-select [(ngModel)]=\"package.branch_key\" class=\"btn-group bootstrap-select bs-select\">\r\n                                <mat-option *ngFor=\"let value of allbranch\" (click)=\"branchOnchange(value.pub_key)\"\r\n                                    [value]=\"value.pub_key\">\r\n                                    {{value.name}}\r\n                                </mat-option>\r\n                            </mat-select>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n                <div *ngIf=\"allunits.length >0\" class=\"form-group kt-form__group row d-block\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n\r\n                        <mat-form-field>\r\n                            <mat-label> All Unite :</mat-label>\r\n                            <mat-select [(ngModel)]=\"package.units_key\" class=\"btn-group bootstrap-select bs-select\">\r\n                                <mat-option *ngFor=\"let value of allunits\" [value]=\"value.pub_key\">\r\n                                    {{value.name}}\r\n                                </mat-option>\r\n                            </mat-select>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput [(ngModel)]=\"package.title\" #title=\"ngModel\"  placeholder=\"Enter title\"  name=\"title\" required pattern=\"[a-zA-Z ]*\" />\r\n                            <mat-error *ngIf=\"title.touched&&!title.valid&&title.errors?.required\">title is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            <mat-error *ngIf=\"title.touched&&!title.valid&&title.errors?.pattern\">Please enter\r\n                                <strong>valid title</strong>\r\n                            </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>title</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput  type=\"text\" placeholder=\"Enter discriptions\"   #discriptions=\"ngModel\" name=\"discriptions\" required pattern=\"[a-zA-Z ]*\"\r\n                            [(ngModel)]=\"package.discriptions\"    />\r\n                                  <mat-error *ngIf=\"discriptions.touched&&!discriptions.valid&&discriptions.errors?.required\">Discriptions is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"discriptions.touched&&!discriptions.valid&&discriptions.errors?.pattern\">Please enter\r\n                                    <strong>valid discriptions</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>discriptions</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput  type=\"number\"  placeholder=\"Enter session time in minutes\"   #session_time=\"ngModel\" name=\"session_time\" required \r\n                            [min]=\"1\"   [(ngModel)]=\"package.session_time\" /> \r\n                            <mat-icon matSuffix>Min</mat-icon>\r\n                                <mat-error *ngIf=\"session_time.touched&&!session_time.valid&&session_time.errors?.required\">Session_time is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"session_time.touched&&!session_time.valid&&session_time.errors?.min\">Please enter\r\n                                    <strong>valid session_time</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Session time in minutes</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput  type=\"number\" placeholder=\"Enter Day Per Week\"    #day_per_week=\"ngModel\" name=\"day_per_week\" required  [min]=\"1\" [max]=\"7\"\r\n                            [(ngModel)]=\"package.day_per_week\"     pattern=\"[1-7]*\"    />\r\n                                  <mat-error *ngIf=\"day_per_week.touched&&!day_per_week.valid&&day_per_week.errors?.required\">Day_per_week is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"day_per_week.touched&&!day_per_week.valid&&(day_per_week.errors?.min||day_per_week.errors?.max||day_per_week.errors?.pattern)\">Please enter\r\n                                    <strong>valid day</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Day Per Week</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput  type=\"number\"  placeholder=\"Enter Month Number\" [(ngModel)]=\"package.month_count\"  #month_count=\"ngModel\" name=\"month_count\" required [min]=\"1\" [max]=\"12\"\r\n                            pattern=\"[0-9]*\"  />\r\n                                  <mat-error *ngIf=\"month_count.touched&&!month_count.valid&&month_count.errors?.required\">Month_count is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"month_count.touched&&!month_count.valid&&(month_count.errors?.min||month_count.errors?.max||month_count.errors?.pattern)\">Please enter\r\n                                    <strong>valid  number</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Month Number</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field>\r\n                            <mat-label> Month System :</mat-label>\r\n                            <mat-select  [(ngModel)]=\"package.month_system\" #month_system=\"ngModel\" name=\"month_system\" class=\"btn-group bootstrap-select bs-select\">\r\n                                <mat-option ng-reflect-value=\"28\" value=\"28\">28 Day</mat-option>\r\n                                <mat-option ng-reflect-value=\"\" value=\"\">Full Month</mat-option>\r\n                            </mat-select>\r\n                            <mat-error *ngIf=\"month_system.touched&&!month_system.valid&&month_system.errors?.required\">Month_system is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n\r\n                <div class=\"form-group kt-form__group row \">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput type=\"text\" #inputBox (change)='validateFees(fees)'\r\n                                placeholder=\"Enter Fees\"    [(ngModel)]=\"package.fees\"  #fees=\"ngModel\" name=\"fees\" required min=\"1\" />\r\n                                <mat-error *ngIf=\"fees.touched&&!fees.valid&&fees.errors?.required\">Fees is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"fees.touched&&!fees.valid&&fees.errors?.min\">Please enter\r\n                                    <strong>valid fees</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Fees</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput type=\"number\"  placeholder=\"Enter Taxs\"   [(ngModel)]=\"package.taxs\"  #taxs=\"ngModel\" name=\"taxs\" required [min]=\"0\" [max]=\"100\" />\r\n                            <mat-icon matSuffix>%</mat-icon>\r\n                            <mat-error *ngIf=\"taxs.touched&&!taxs.valid&&taxs.errors?.required\">Taxs is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            <mat-error *ngIf=\"taxs.touched&&!taxs.valid&&(taxs.errors?.min||taxs.errors?.max)\">Please enter\r\n                                <strong>valid taxs</strong>\r\n                            </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Taxs</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput placeholder=\"Enter Payment strategy\"\r\n                            [(ngModel)]=\"package.payment_startegy\"  #payment_strategy=\"ngModel\" name=\"payment_strategy\" required   pattern=\"[0-9]*\"/>\r\n                                  <mat-error *ngIf=\"payment_strategy.touched&&!payment_strategy.valid&&payment_strategy.errors?.required\">Payment strategy is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"payment_strategy.touched&&!payment_strategy.valid&&payment_strategy.errors?.pattern\">Please enter\r\n                                    <strong>valid Payment strategy</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Payment strategy</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field>\r\n                            <mat-label> Type * </mat-label>\r\n                            <mat-select  [(ngModel)]=\"package.type\" #type=\"ngModel\" name=\"type\" required class=\"btn-group bootstrap-select bs-select\">\r\n                                <mat-option ng-reflect-value=\"general\" value=\"general\">General</mat-option>\r\n                                <mat-option ng-reflect-value=\"private\" value=\"private\">Private</mat-option>\r\n                            </mat-select>\r\n                            <mat-error *ngIf=\"type.touched&&!type.valid&&type.errors?.required\">Please enter\r\n                                <strong>type</strong>\r\n                            </mat-error>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n                <div class=\"form-group kt-form__group row \">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput type=\"number\"  placeholder=\"Enter Discount\" [(ngModel)]=\"package.discount\"  #discount=\"ngModel\" name=\"discount\" required \r\n                            [min]=\"0\" [max]=\"100\"/>\r\n                            <mat-icon matSuffix>%</mat-icon>\r\n                                  <mat-error *ngIf=\"discount.touched&&!discount.valid&&discount.errors?.required\">Discount is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"discount.touched&&!discount.valid&&(discount.errors?.min||discount.errors?.max)\">Please enter\r\n                                    <strong>valid discount</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Discount</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput [min]=\"mindate\" date [(ngModel)]=\"package.start_discount\"  #start_discount=\"ngModel\" name=\"start_discount\" required \r\n                                [matDatepicker]=\"picker1\" placeholder=\"Enter Start Discount\">\r\n                            <mat-datepicker-toggle matSuffix [for]=\"picker1\"></mat-datepicker-toggle>\r\n                            <mat-datepicker disabled=\"false\"  #picker1></mat-datepicker>\r\n                            <mat-error *ngIf=\"start_discount.touched&&!start_discount.valid&&start_discount.errors?.required\">Start_discount is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            <mat-error *ngIf=\"start_discount.touched&&!start_discount.valid&&(start_discount.errors?.min||start_discount.errors?.date)\">Please enter\r\n                                <strong>valid date</strong>\r\n                            </mat-error>\r\n                            \r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Start Discount</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n                \r\n\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"example-full-width\">\r\n                            <input matInput [min]=\"mindate\" date [(ngModel)]=\"package.end_discount\"  #end_discount=\"ngModel\" name=\"end_discount\" required \r\n                                [matDatepicker]=\"picker\" placeholder=\"Enter End Discount\" >\r\n                            <mat-datepicker-toggle matSuffix [for]=\"picker\"></mat-datepicker-toggle>\r\n                            <mat-datepicker disabled=\"false\" #picker></mat-datepicker>\r\n                            \r\n                            <mat-error *ngIf=\"end_discount.touched&&!end_discount.valid&&end_discount.errors?.required\">End_discountis\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            <mat-error *ngIf=\"end_discount.touched&&!end_discount.valid&&(end_discount.errors?.min||end_discount.errors?.date)\">Please enter\r\n                                <strong>valid date</strong>\r\n                            </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>End Discount</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput type=\"text\" (change)='validateFees(renew_fees)'\r\n                                placeholder=\"Enter Renew Fees\"   [(ngModel)]=\"package.renew_fees\"  #renew_fees=\"ngModel\" name=\"renew_fees\" required min=\"1\" />\r\n                            <mat-error>Renew Fees is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            <mat-error *ngIf=\"renew_fees.touched&&!renew_fees.valid&&renew_fees.errors?.required\">Renew_fees is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            <mat-error *ngIf=\"renew_fees.touched&&!renew_fees.valid&&title.errors?.min\">Please enter\r\n                                <strong>valid renew_fees</strong>\r\n                            </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Renew Fees</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput type=\"number\" placeholder=\"Enter Renew Taxs\"  [(ngModel)]=\"package.renew_taxs\"  #renew_taxs=\"ngModel\" name=\"renew_taxs\" required min=\"0\" \r\n                            [max]=\"100\"    />\r\n                            <mat-icon matSuffix>%</mat-icon>\r\n                                <mat-error *ngIf=\"renew_taxs.touched&&!renew_taxs.valid&&renew_taxs.errors?.required\">Renew_taxs is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"renew_taxs.touched&&!renew_taxs.valid&&(renew_taxs.errors?.min||renew_taxs.errors?.max)\">Please enter\r\n                                    <strong>valid renew_taxs</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Renew Taxs</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput type=\"number\"  placeholder=\"Enter Renew Discount\"  [(ngModel)]=\"package.renew_discount\"  #renew_discount=\"ngModel\" name=\"renew_discount\" required [min]='0'\r\n                             [max]=\"100\"     />\r\n                             <mat-icon matSuffix>%</mat-icon>\r\n                                  <mat-error *ngIf=\"renew_discount.touched&&!renew_discount.valid&&renew_discount.errors?.required\">Renew_discount is\r\n                                    <strong>required</strong>\r\n                                </mat-error>\r\n                                <mat-error *ngIf=\"renew_discount.touched&&!title.valid&&(renew_discount.errors?.min||renew_discount.errors?.max)\">Please enter\r\n                                    <strong>valid renew_discount</strong>\r\n                                </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Renew Discount</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n                <!-- end renew -->\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput placeholder=\"Enter Additional Service\"   [(ngModel)]=\"package.additional_service\"  #additional_service=\"ngModel\" name=\"additional_service\" required \r\n                                 />\r\n                            <mat-error>Additional Service is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Additional Service</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput placeholder=\"Enter Additional Invitations\"\r\n                            [(ngModel)]=\"package.additional_invitation\"  #additional_invitation=\"ngModel\" name=\"additional_invitation\" required  />\r\n\r\n                            <mat-error *ngIf=\"additional_invitation.touched&&!additional_invitation.valid&&additional_invitation.errors?.required\">Additional_invitation is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n                            \r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Additional Invitations</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n\r\n\r\n                <div class=\"form-group kt-form__group row\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <mat-form-field class=\"mat-form-field-fluid\">\r\n                            <input matInput placeholder=\"Enter Additional Visits\"\r\n                            [(ngModel)]=\"package.additional_visits\"  #additional_visits=\"ngModel\" name=\"additional_visits\" required/>\r\n                            <mat-error>Additional Visits is\r\n                                <strong>required</strong>\r\n                            </mat-error>\r\n\r\n                            <mat-hint align=\"start\">Please enter\r\n                                <strong>Additional Visits</strong>\r\n                            </mat-hint>\r\n                        </mat-form-field>\r\n                    </div>\r\n                </div>\r\n\r\n\r\n                <!-- <div class=\"col-md-9\">\r\n                  <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\r\n\r\n                      <div class=\"fileinput-new thumbnail\" style=\"width: 200px; height: 150px;\">\r\n                          <img *ngIf=\"imageprivew==''\" src=\"http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image\" alt=\"\">\r\n                          <img *ngIf=\"imageprivew !=''\" src=\"{{imageprivew}}\" alt=\"\"> </div>\r\n                      <div class=\"fileinput-preview fileinput-exists thumbnail\" style=\"max-width: 200px; max-height: 150px;\"> </div>\r\n                      <div>\r\n                          <span class=\"btn default btn-file\">\r\n                              <span *ngIf=\"imageprivew == ''\" class=\"fileinput-new btn btn-success btn-s\"> Select image </span>\r\n                              <span *ngIf=\"imageprivew != ''\" class=\"fileinput-new btn btn-success btn-s\"> Change </span>\r\n                              <input type=\"file\" name=\"photo\" (change)=\"handleUpload($event)\" ng2FileSelect [uploader]=\"uploader\" /> </span>\r\n                          <button type=\"button\" *ngIf=\"imageprivew != '' && !confirm\" class=\"btn btn-success btn-s\"\r\n                            (click)=\"uploader.uploadAll()\"\r\n                            [disabled]=\"!uploader.getNotUploadedItems().length\" >\r\n                                Confirm\r\n                          </button>\r\n                      </div>\r\n                  </div>\r\n                </div> -->\r\n                <!-- Image_url Field -->\r\n                <div class=\"form-group kt-form__group row d-block\">\r\n                    <div class=\"col-lg-6 kt-margin-bottom-20-mobile\">\r\n                        <div class=\"fileinput fileinput-new\" data-provides=\"fileinput\">\r\n\r\n                            <div class=\"fileinput-new thumbnail\" style=\"width: 300px; height: 300px;\">\r\n                                <img *ngIf=\"imageprivew ==''\"\r\n                                    src=\"http://www.placehold.it/300x300/EFEFEF/AAAAAA&amp;text=no+image\" alt=\"\">\r\n                                <img *ngIf=\"imageprivew !=''\" src=\"{{imageprivew}}\" alt=\"\">\r\n                            </div>\r\n                            <div>\r\n                                <label for=\"file-upload\" class=\"custom-file-upload fileinput-new btn btn-success btn-s\">\r\n                                    <i class=\"fa fa-cloud-upload\"></i> Upload Image</label>\r\n                                <input id=\"file-upload\" style=\"display: none;\" type=\"file\" name=\"file\" #input_image\r\n                                    (change)=\"handleUpload($event)\" ng2FileSelect [uploader]=\"uploader\" />\r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n\r\n                <div class=\"kt-separator kt-separator--dashed\"></div>\r\n\r\n            </div>\r\n            <div class=\"kt-portlet__foot kt-portlet__foot--fit kt-portlet__no-border\">\r\n                <div class=\"kt-form__actions kt-form__actions--solid\">\r\n                    <div class=\"row text-right\">\r\n                        <div class=\"col-lg-12\">\r\n                            <button type=\"button\" mat-raised-button [mat-dialog-close]=\"data.animal\" cdkFocusInitial\r\n                                matTooltip=\"Cancel changes\">\r\n                                Cancel\r\n                            </button>&nbsp;\r\n                            <button type=\"button\" mat-raised-button color=\"primary\" (click)=\"onSubmit()\"\r\n                                [disabled]=\"viewLoading\" matTooltip=\"Save changes\">\r\n                                Save\r\n                            </button>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n\r\n        </div>\r\n    </div>\r\n</div>"

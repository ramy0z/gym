...
var InvitationComponent = /** @class */ (function () {
    ...
    // 	)
    // }
    InvitationComponent.prototype.revokeinvitation = function (id, rowIndex) {
        var _this = this;
        var _title = 'Revoke Invitation';
        var _description = 'Are you sure to Revoke this User?';
        ...
        dialogRef.afterClosed().subscribe(function (res) {
            if (!res) {
                ...
                _this.ser.reVokeInvitations(id).subscribe(function (res) {
                    if (res['result']) {
                        ...
                        _this.dataSource["data"][rowIndex]["status"] = 'revoked';
                    }
                    else {
                        setTimeout(function () {
                            _this.layoutUtilsService.showActionNotification(res['data'], crud_1.MessageType.Update);
    ...
    InvitationComponent.prototype.resendinvitation = function (id, rowIndex) {
        ...
        this.ser.reSendInvitations(id).subscribe(function (res) {
            ...
            if (res['result']) {
                ...
                _this.dataSource["data"][rowIndex]["createdat"] = new Date();
...
var RoleEditDialogComponent = /** @class */ (function () {
    ...
    RoleEditDialogComponent.prototype.ngOnInit = function () {
        ...
        if (typeof this.data.isThereDefault != 'undefined') {
            //this is add state
        }
        else {
        }
...
var RolesListComponent = /** @class */ (function () {
    ...
    RolesListComponent.prototype.editRole = function (role) {
        ...
        var isThereDefault = this.isThereDefault;
        var dialogRef = this.dialog.open(role_edit_dialog_component_1.RoleEditDialogComponent, { data: { "role": role, "isThereDefault": isThereDefault } });
        dialogRef.afterClosed().subscribe(function (res) {
            if (!res) {
                return;
            }
...
module.exports = ".text {\n  font-size: 15px;\n  color: black; }\n\n.postion {\n  margin-left: 30px; }\n\nmat-list.list-horizontal {\n  padding: 0;\n  margin-left: 30px; }\n\nmat-list.list-horizontal .mat-list-item {\n    display: inline-block;\n    height: auto;\n    width: auto; }\n\n.mat-expansion-panel:not([class*='mat-elevation-z']) {\n  box-shadow: 0px 0px 0px 0px rgba(0, 0, 0, 0.2), 0px 0px 0px 0px rgba(0, 0, 0, 0.14), 0px 0px 0px 0px rgba(0, 0, 0, 0.12); }\n\n.prevent-click {\n  pointer-events: none; }\n\n.mat-expansion-panel-header {\n  height: 20px !important; }\n\n.mat-content {\n  flex: 0.5 !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AccessRightComponent = /** @class */ (function () {
    ...
    ChangeDetectorRef, activatedRoute, store, ser, router, layoutUtilsService) {
        ...
        this.allbrancandunits.push({ name: 'All Branchs', 'pub_key': this.current_club_login, 'checked': false, });
    }
    /**
     * @ Lifecycle sequences => https://angular.io/guide/lifecycle-hooks
     */
                    ...
                    if (res) {
                        if (_this.user['privilidge']) {
                            if (_this.checkedpermission('editprivilidges')) {
                                ...
                                dialogRef.afterClosed().subscribe(function (resdialog) {
                                    if (!resdialog) {
                                        _this.submited = false;
                                        _this.changeDetectorRefs.detectChanges();
                                        return;
                            ...
                            if (_this.checkedpermission('addprivilidges')) {
                                if (!res['role']) {
                                    ...
                                    if (!res['role'].privilidge || !res['role'].typeOfRole || !_this.user['pub_key']) {
                                        ...
                                        dialogRef.afterClosed().subscribe(function (afterClosed) {
                                            if (!afterClosed) {
                                                _this.submited = false;
                                                _this.changeDetectorRefs.detectChanges();
                                                return;
...
var UsersListComponent = /** @class */ (function () {
     ...
     * @param layoutUtilsService: LayoutUtilsService
     */
    function UsersListComponent(activatedRoute, store, router, layoutUtilsService, cdr, ser) {
        this.activatedRoute = activatedRoute;
        this.store = store;
        this.router = router;
        this.layoutUtilsService = layoutUtilsService;
        this.cdr = cdr;
        this.ser = ser;
        this.displayedColumns = ['select', 'id', '_username', '_email', 'fullname', '_roles', '_status', 'actions'];
        // Selection
        this.selection = new collections_1.SelectionModel(true, []);
        this.allRoles = [];
        this.SearchKey = '';
    ...
    UsersListComponent.prototype.activateuser = function (id, status, rowIndex) {
        var _this = this;
        this.usrListIconNo = (status == 'Active') ? 1 : 2;
        this.currentRowIndex = rowIndex;
        var _title = 'User ' + status;
        var _description = 'Are you sure to ' + status + ' this user?';
        var _waitDesciption = 'Processing...';
        var dialogRef = this.layoutUtilsService.RenwElement(_title, _description, _waitDesciption);
        dialogRef.afterClosed().subscribe(function (res) {
            if (res) {
                ...
                _this.ser.activateuser(ids, status, club_key).subscribe(function (result) {
                    ...
                    _this.listData["data"][rowIndex]["status"] = status;
    ...
    UsersListComponent.prototype.activeallusers = function (status) {
        var _this = this;
        var _title = 'Users ' + status;
        var _description = 'Are you sure to ' + status + ' these users?';
        var _waitDesciption = 'Processing...';
        var dialogRef = this.layoutUtilsService.RenwElement(_title, _description, _waitDesciption);
        dialogRef.afterClosed().subscribe(function (res) {
            _this.isLoading = true;
            var ids = [];
            _this.selection.selected.forEach(function (elem) {
            ...
            if (status == 'Active')
                ...
                var message = 'User DeActivated Successfully';
            var club_key = JSON.parse(localStorage.getItem('user'))['current_club_login'];
            _this.ser.activateuser(ids, status, club_key).subscribe(function (res) {
    ...
    UsersListComponent.prototype.masterToggle = function () {
        var _this = this;
        if (this.selection.selected.length === this.listData['data'].length) {
            this.selection.clear();
        }
        else {
            this.listData['data'].forEach(function (row) { return _this.selection.select(row); });
        }
    };
    /* UI */
    /**
